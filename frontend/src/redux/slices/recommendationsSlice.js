...
export const fetchRecommendations = createAsyncThunk('recommendations/fetch', async (businessDetails, { rejectWithValue }) => {
  try {
    ...
    // Return realistic structured recommendations grouped by Content, Website, SEO, Ads, Business
    return [
      {
        category: "Content",
